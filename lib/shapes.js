class Render {
    ...
    renderShapes() {
        ...
        if (this.shape === 'Triangle') {
            ...
            <text x="100" y="125" text-anchor="middle" font-family="monospace" font-size="29" font-weight="bold" letter-spacing="1.5" fill="${this.textColor}">${this.text}</text>`;
        } else {
            const shapes = {
            ...
            <text x="100" y="108" text-anchor="middle" font-family="monospace" font-size="32" font-weight="bold" letter-spacing="1.5" fill="${this.textColor}">${this.text}</text>`;
        }
